...
DIR_RIGHT = 3
ANIMATION = [0, 1, 0, 2]
BLINK = ["#fff","#ffc","#ff8","#fe4","#ff8","#ff8","#ffc"]
idx = 0
tmr = 0
stage = 1
score = 0
...
def main(): # メインループ
    ...
    if idx == 5: # エンディング
        if tmr == 60:
            ...
            canvas.create_image(0,0,720,540,image=img_ending,tag="SCREEN")
...
img_bg = [
    tkinter.PhotoImage(file="act4/image_penpen/chip00.png"),
    tkinter.PhotoImage(file="act4/image_penpen/chip01.png"),
    tkinter.PhotoImage(file="act4/image_penpen/chip02.png"),
    tkinter.PhotoImage(file="act4/image_penpen/chip03.png")
]
img_pen = [
    tkinter.PhotoImage(file="act4/image_penpen/pen00.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen01.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen02.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen03.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen04.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen05.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen06.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen07.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen08.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen09.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen10.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen11.png"),
    tkinter.PhotoImage(file="act4/image_penpen/pen_face.png")
]
img_red = [
    tkinter.PhotoImage(file="act4/image_penpen/red00.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red01.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red02.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red03.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red04.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red05.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red06.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red07.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red08.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red09.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red10.png"),
    tkinter.PhotoImage(file="act4/image_penpen/red11.png")
]

img_kuma = [
    tkinter.PhotoImage(file="act4/image_penpen/kuma00.png"),
    tkinter.PhotoImage(file="act4/image_penpen/kuma01.png"),
    tkinter.PhotoImage(file="act4/image_penpen/kuma02.png")
]

img_title = tkinter.PhotoImage(file="act4/image_penpen/title.png")
img_ending = tkinter.PhotoImage(file="act4/image_penpen/ending.png")
