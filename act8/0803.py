...
# 画像の読み込み
img_galaxy = pygame.image.load("act8/image_gl/galaxy.png")
img_sship = [
    pygame.image.load("act8/image_gl/starship.png"),
    pygame.image.load("act8/image_gl/starship_l.png"),
    pygame.image.load("act8/image_gl/starship_r.png"),
    pygame.image.load("act8/image_gl/starship_burner.png")
]
img_weapon = pygame.image.load("act8/image_gl/bullet.png")
img_shield = pygame.image.load("act8/image_gl/shield.png")
img_enemy = [
    pygame.image.load("act8/image_gl/enemy0.png"),
    pygame.image.load("act8/image_gl/enemy1.png"),
    pygame.image.load("act8/image_gl/enemy2.png"),
    pygame.image.load("act8/image_gl/enemy3.png"),
    pygame.image.load("act8/image_gl/enemy4.png"),
    pygame.image.load("act8/image_gl/enemy_boss.png"),
    pygame.image.load("act8/image_gl/enemy_boss_f.png")
    ]
img_explode = [
    None,
    pygame.image.load("act8/image_gl/explosion1.png"),
    pygame.image.load("act8/image_gl/explosion2.png"),
    pygame.image.load("act8/image_gl/explosion3.png"),
    pygame.image.load("act8/image_gl/explosion4.png"),
    pygame.image.load("act8/image_gl/explosion5.png")
]
img_title = [
    pygame.image.load("act8/image_gl/nebula.png"),
    pygame.image.load("act8/image_gl/logo.png")
]
# SEを読み込む変数
se_barrage = None
se_damage = None
...
def bring_enemy(): # 敵を出す
    sec = tmr/30
    if 0 < sec and sec < 15 and tmr%60 == 0:
    ...
    while True:
        ...
        if idx == 2: # ゲームオーバー
            ...
            if tmr <= 90:
                ...
                if tmr%10 == 0:
                    se_damage.play()
            if tmr == 120:
                pygame.mixer.music.load("act8/sound_gl/gameover.ogg")
        ...
        if idx == 3: # ゲームクリア
            ...
            if tmr == 1:
                pygame.mixer.music.stop()
            if tmr == 2:
                pygame.mixer.music.load("act8/sound_gl/gameclear.ogg")
                pygame.mixer.music.play(0)
            if tmr > 20:
