...
# 画像の読み込み
img_galaxy = pygame.image.load("act7/image_gl/galaxy.png")
img_sship = [
    pygame.image.load("act7/image_gl/starship.png"),
    pygame.image.load("act7/image_gl/starship_l.png"),
    pygame.image.load("act7/image_gl/starship_r.png"),
    pygame.image.load("act7/image_gl/starship_burner.png")
]
img_weapon = pygame.image.load("act7/image_gl/bullet.png")
img_shield = pygame.image.load("act7/image_gl/shield.png")
img_enemy = [
    pygame.image.load("act7/image_gl/enemy0.png"),
    pygame.image.load("act7/image_gl/enemy1.png")
]
img_explode = [
    None,
    pygame.image.load("act7/image_gl/explosion1.png"),
    pygame.image.load("act7/image_gl/explosion2.png"),
    pygame.image.load("act7/image_gl/explosion3.png"),
    pygame.image.load("act7/image_gl/explosion4.png"),
    pygame.image.load("act7/image_gl/explosion5.png")
]

img_title = [
    pygame.image.load("act7/image_gl/nebula.png"),
    pygame.image.load("act7/image_gl/logo.png")
]
